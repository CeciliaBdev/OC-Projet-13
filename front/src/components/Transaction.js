...
function Transaction({ account_ID, title, amount, description }) {
  return (
    ...
    <div className="border border-red md:w-[100%] sm:w-[90%] h-24 text-left p-4  text-slate-500 text-base bg-white md:flex md:flex-row justify-between items-center md:h-24  s:h-40 s:flex-col">
      <div>
